# Generated by Django 4.1.5 on 2023-05-24 00:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evenement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='api_evotech.evenement')),
            ],
        ),
    ]
